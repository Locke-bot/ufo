        ...
        if (!t(o).data("bxSlider")) {
            var l = function() {
              ...
              , Y = function(t) {
                ...
                if (Boolean(["textarea", "input", "h1", "h2", "h3", "h4", "h5", "h6"].filter(c=>c==$(t.target)[0].tagName.toLowerCase()).length)){ // t.target.type i the tag name of the element, added customly
                    return
                }
                else if ("touchstart" === t.type || 0 === t.button)
                    console.log("mad o", t.type)
                    if (t.preventDefault(),
